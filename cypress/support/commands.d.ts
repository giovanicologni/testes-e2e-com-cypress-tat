...
declare namespace Cypress {
    interface Chainable {
        /**
         * Loga na aplicação Scratch via GUI (Graphical User Interface)
         * 
         * @param username string - O email do usuário que você quer logar
         * @param password string - A senha do usuário que você quer logar
         * 
         * @example cy.guilogin() // Loga na aplicação utilizando os valores definidos nas variáveis de ambiente
         * @example cy.guiLogin('user@email.com','S3cRe7P@ssW0rd') //Loga na aplicação utilizando os valores providos por parâmetro
         */
